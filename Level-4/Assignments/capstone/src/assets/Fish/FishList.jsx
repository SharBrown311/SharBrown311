...
import './Fish.css'
import RarityStars from './FishRarityStars'
...
function FishList() {
  ...
  useEffect(() => {
    sessionStorage.setItem('checkedFish', JSON.stringify(checkedFish));
  }, [checkedFish]);
  ...
  return (
    ...
    <div className='left-content-list'>
      ...
      <div className='name-image-container'>
          ...
          <p className='time'> Time available:  {fish.availability.time ? fish.availability.time: 'All Year'}</p>
      ...
      {selectedFish && (
        <div className='main-fish-div-2'>
          ...
          <p className='details'><span>Time:</span> {selectedFish.availability.time ? selectedFish.availability.time : 'Available always'}</p>
